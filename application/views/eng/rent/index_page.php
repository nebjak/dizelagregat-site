...
<html>
    <head>
        ...
        <title>Rent :: Diesel generator sets :: Energoglobal doo - Novi Sad - Serbia</title>
        ...
        <div class="container_12">
            ...
            <div class="grid_8" id="box1">
                <ul>
                    ...
                    <li class="current_page_item"><a href="<?= base_url() ?>eng/rent">Rent</a></li>
            ...
            <div class="grid_12" id="box2">
                <form>
                    <table>
                        <tr>
                            <td style="width: 15%;">
                                <a href="<?=base_url()?>srb/rental">SR</a>
        ...
        <div id="box4">
            <div class="container_12" id="box5">
                <div class="grid_9" id="box6">
                    ...
                    <h1>Rent</h1>
                    <p>
                        ENERGOGLOBAL rent is company division specialized in 
                        renting of diesel gen-sets. We own a rental fleet with 
                        wide variety of different power gen-sets to be rented, 
                        but also to be installed, taken into use, transported or 
                        operated by our skilled personnel.
                    </p>
                </div>
